...
inline void makeTypes(nb::module_ &m) {
  ...
  nb::class_<Point>(m, "Point")
      ...
      .doc() = "Point is a general point structure in evalio, with common "
  ...
  nb::class_<LidarParams>(m, "LidarParams")
      ...
      .doc() = "LidarParams is a structure for storing the parameters of a "
               "lidar sensor.";
  ...
  nb::class_<SO3>(m, "SO3")
      ...
      .def_static("fromMat", &SO3::fromMat, "mat"_a,
                  "Create a rotation from a 3x3 rotation matrix.")
      .def_static("exp", &SO3::exp, "v"_a,
      ...
      .def("__setstate__",
           [](SO3 &p, std::tuple<double, double, double, double> t) {
             new (&p) SO3{.qx = std::get<0>(t),
                          .qy = std::get<1>(t),
                          .qz = std::get<2>(t),
                          .qw = std::get<3>(t)};
           })
      .doc() = "SO3 class for representing a 3D rotation using a quaternion. "
  ...
  nb::class_<SE3>(m, "SE3")
      ...
      .def_static("fromMat", &SE3::fromMat, "mat"_a,
      ...
      .doc() = "SE3 class for representing a 3D rigid body transformation "
